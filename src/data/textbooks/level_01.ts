...
export const textbooks_level_01: Textbook[] = [
    {
        ...
        "schema_activation": [
            "あなたのお<ruby>名前<rt>なまえ</rt></ruby>はなんですか",
            "あなたはおいくつですか"
        ],
        ...
        "quizzes": [
            {
                ...
                "target_id": "L01_03_Q1",
                "choices": [
                    "<ruby>20歳<rt>はたち</rt></ruby>",
                    "25<ruby>歳<rt>さい</rt></ruby>",
