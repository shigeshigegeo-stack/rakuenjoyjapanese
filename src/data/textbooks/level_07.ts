...
export const textbooks_level_07: Textbook[] = [
    {
        ...
        "textbook_html": "<p><ruby>山田<rt>やまだ</rt></ruby>「アナさん、プレゼントです。チョコレートを あげます」<br>アナ「ありがとうございます。すぐに <ruby>食<rt>た</rt></ruby>べます」<br>山田「<ruby>手<rt>て</rt></ruby>で <ruby>食<rt>た</rt></ruby>べますか」<br><span id=\"L07_01_Q1\">アナ「いいえ、フォークで <ruby>食<rt>た</rt></ruby>べます。<ruby>私<rt>わたし</rt></ruby>の <ruby>国<rt>くに</rt></ruby>では <ruby>箸<rt>はし</rt></ruby>を <ruby>使<rt>つか</rt></ruby>いません」</span>アナさんは チョコレートを <ruby>食<rt>た</rt></ruby>べました。とても おいしかったです。</p>",
        "quizzes": [
            {
                "question": "アナさんは <ruby>何<rt>なに</rt></ruby>で チョコレートを <ruby>食<rt>た</rt></ruby>べますか。",
                "target_id": "L07_01_Q1",
                "choices": [
